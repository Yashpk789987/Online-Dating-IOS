        ...
        <Modal
          ...
          <Container style={{backgroundColor: 'white'}}>
            <View
              ...
              <ImageLoad
                source={{
                  uri: `${baseurl}/user_images/${this.state.caller_info.profile_pic}`,
                }}
                style={{width: 200, height: 200, borderRadius: 100}}
              />
              <Text style={{fontSize: 40}}>
                {this.state.caller_info.username}
              </Text>
          ...
          <Right>
            <TouchableOpacity
              ...
              <Thumbnail
                ...
                source={{
                  uri: `${baseurl}/user_images/${this.state.me.profile_pic}`,
                }}
              />
            </TouchableOpacity>
          </Right>
          ...
          <FlatList
            ...
            renderItem={({item}) => {
              return (
                <ListItem
                  onPress={() =>
                    this.props.screenProps.stackRef.navigate('ViewProfile', {
                      userId: item.id,
                    })
                  }
                  avatar>
                  <Left>
                    <Thumbnail
                      source={{
                        uri: `${baseurl}/user_images/${item.profile_pic}`,
                      }}
                    />
                  </Left>
                  <Body>
